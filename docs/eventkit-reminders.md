...
| Changes | `EKEventStoreChangedNotification` invalidates previously fetched data. It supplies neither the durable cursor nor deletion records this pipeline needs for incremental reconciliation. Use full refresh. |
